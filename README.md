...
```markdown
[![License: NPF 1.0](https://img.shields.io/badge/License-NPF%201.0-e25822.svg)](LICENSE_EN)
```

**Option B — self-hosted SVG from this repo:**
```markdown
[![License: NPF 1.0](https://raw.githubusercontent.com/nikolaynnov/npf-license/master/badges/npf-badge.svg)](https://github.com/nikolaynnov/npf-license/blob/master/LICENSE_EN)
```

**Option B (via jsDelivr CDN, most reliable content-type):**
```markdown
[![License: NPF 1.0](https://cdn.jsdelivr.net/gh/nikolaynnov/npf-license@master/badges/npf-badge.svg)](https://github.com/nikolaynnov/npf-license/blob/master/LICENSE_EN)
```
